...
install_packages bash-completion man-pages inxi brightnessctl zip unzip
...
install_packages dosfstools exfatprogs e2fsprogs

install_packages orchis-theme tela-circle-icon-theme-standard
install_packages noto-fonts-emoji otf-font-awesome
install_packages ttf-roboto ttf-liberation ttf-jetbrains-mono

install_packages tk gtk3 gtk4 qt5-wayland qt6-wayland hyprland
install_packages flatpak xdg-utils xdg-desktop-portal-hyprland grim slurp
install_packages hypridle hyprlock hyprpaper hyprpicker hyprpolkitagent
...
install_packages mousepad ristretto parole gparted fwupd
install_packages galculator gcolor3 gimp mission-center qemu-desktop
